...
private Funcionario funcionario;
	...
	public void excluir() {
		...
		try { 
			...
			JSFUtil.adicionarMensagemSucesso("Funcionário excluído com sucesso!");
		
		} catch (RuntimeException e) {
			JSFUtil.adicionarMensagemErro("Não foi possível excluir o funcionário pois o mesmo possui uma venda associada.");
			e.printStackTrace();
		}
